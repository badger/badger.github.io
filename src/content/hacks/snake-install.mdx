...
github: "https://github.com/badger/tufty/tree/main/badge/apps/snake"
---
...
1. **Download the Tufty sources**
  - In a browser go to the [badger/tufty repository](https://github.com/badger/tufty).
...
Review the full source for scoring and controls: [`badge/apps/snake/__init__.py`](https://github.com/badger/tufty/blob/main/badge/apps/snake/__init__.py#L31-L211).
