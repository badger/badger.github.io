...
github: "https://github.com/badger/home/blob/main/badge/secrets.py"
featured: 1
---
...
Note that at the Universe event, there is a WiFi access point
that you can connect to in the "Hack The Badge" area.
...
Reference: [`badge/apps/badge/__init__.py`](https://github.com/badger/home/blob/main/badge/apps/badge/__init__.py#L36-L78).
