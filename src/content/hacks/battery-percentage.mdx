...
description: "Show battery percentage beside the menu battery icon."
...
github: "https://github.com/badger/home/blob/main/badge/apps/menu/ui.py"
---
...
2. **Edit `badger volume/apps/menu/ui.py` in VS Code**
  - In VS Code, use **File → Open...** to open the badger volume, then open `apps/menu/ui.py`.
   - In your browser, open the upstream [`menu/ui.py`](https://github.com/badger/home/blob/main/badge/apps/menu/ui.py), click **Raw**, and keep it handy for reference.
