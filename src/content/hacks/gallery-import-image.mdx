...
github: "https://github.com/badger/tufty/tree/main/badge/apps/gallery"
---
...
The code expects a PNG in both `images/` and `thumbnails/` using the same filename. Source: [`badge/apps/gallery/__init__.py`](https://github.com/badger/tufty/blob/main/badge/apps/gallery/__init__.py#L10-L71).
