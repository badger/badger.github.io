...
preloaded: false
customizable: false
fileLocation: "/system/apps/snake"
---
...
1. Copy the `badge/apps/snake/` folder from [`badger/tufty`](https://github.com/badger/tufty/tree/main/badge/apps/snake).
...
- [Snake game](https://github.com/badger/tufty/blob/main/badge/apps/snake/__init__.py)
