---
title: "Gallery"
description: "Photo viewer with thumbnail carousel. 7-image preview strip. Auto-hiding UI after 2s inactivity."
...
2. **Add images** to `/apps/gallery/images/` folder
3. **Add matching thumbnails** to `/apps/gallery/thumbnails/` folder
...
- [Main gallery app](https://github.com/badger/home/blob/main/badge/apps/gallery/__init__.py)
