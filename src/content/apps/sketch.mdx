...
preloaded: true
customizable: false
fileLocation: "/system/apps/sketch"
---
...
Monasketch is located at `/system/apps/sketch` on your Badger 2350 filesystem.
...
- [Main app and drawing logic](https://github.com/badger/tufty/blob/main/badge/apps/sketch/__init__.py)
- [UI and Mona rendering](https://github.com/badger/tufty/blob/main/badge/apps/sketch/ui.py)
